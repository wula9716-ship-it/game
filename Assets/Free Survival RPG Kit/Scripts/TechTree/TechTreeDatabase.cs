...
public class TechTreeCreator : MonoBehaviour
{
    ...
    // Removed ItemDatabase dependency - use scriptable object Items directly
    ...
    /// <summary>
    /// 获取物品 (需要配置 ScriptableObject Item 引用)
    /// </summary>
    private Item GetItem(string name)
    {
        // TODO: Load item from Resources or serialized reference
        // For now, return null - items should be set via SerializedField
        Debug.LogWarning("GetItem not implemented - use direct Item references");
        return null;
    }
}